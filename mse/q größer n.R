...
plot(lamlist2, MSEr, type = "l", ylim = c(0,maxmse), main = paste("Ridge, q = ",q,", n = ",n, ", N = ",N, sep = ""),
     col = "#440154", lwd = 3, xlab = "log(Lambda)", ylab = "MSE")
lines(lamlist2, v_r, col = "#21918c", lwd = 2.5)
lines(lamlist2, bi2_r, col = "#fde725", lwd = 2.5)


plot(lamlist2, MSEl, type = "l", ylim = c(0,maxmse), main = paste("Lasso, q = ",q,", n = ",n, ", N = ",N, sep = ""),
     col = "#440154", lwd = 3, xlab = "log(Lambda)", ylab = "MSE")
lines(lamlist2, v_l, col = "#21918c", lwd = 2.5)
lines(lamlist2, bi2_l, col = "#fde725", lwd = 2.5)


plot(lamlist2, MSEel, type = "l", ylim = c(0,maxmse), main = paste("EN 0.5, q = ",q,", n = ",n, ", N = ",N, sep = ""),
     col = "#440154", lwd = 3, xlab = "log(Lambda)", ylab = "MSE")
...
plot(lamlist2, MSEr, type = "l", ylim = c(0,maxmse), col = "#1F77B4", lwd = 2.5,
     main = paste("Vergleich MSE, q = ",q,", n = ",n, ", N = ",N, sep = ""), xlab = "log(Lambda)", ylab = "MSE")
