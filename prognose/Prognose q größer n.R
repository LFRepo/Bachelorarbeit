...
#boxplot(ri, main = "Optimale Prognose Ridge, q = 200, n = 100, N = 100", ylab = "log(lambda)")
#boxplot(la, main = "Optimale Prognose Lasso, q = 200, n = 100, N = 100", ylab = "log(lambda)")
#boxplot(el, main = "Optimale Prognose EN 0.5, q = 200, n = 100, N = 100", ylab = "log(lambda)")
