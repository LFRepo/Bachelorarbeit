...
#boxplot(ri, main = "c Optimale Prognose Ridge, n = 100, N = 100", ylim = c(-12,3), ylab = "log(lambda)")
#boxplot(la, main = "c Optimale Prognose Lasso, n = 100, N = 100", ylim = c(-12,3), ylab = "log(lambda)")
#boxplot(el, main = "c Optimale Prognose Elastic Net 0.5, n = 100, N = 100", ylim = c(-12,3), ylab = "log(lambda)")
