...
#boxplot(ri, main = "Optimale Prognose Ridge Dummy", ylab = "log(lambda)")
#boxplot(la, main = "Optimale Prognose Lasso, Dummy", ylab = "log(lambda)")
#boxplot(el, main = "Optimale Prognose EN 0.5, Dummy", ylab = "log(lambda)")
