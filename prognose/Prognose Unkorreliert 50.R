...
#boxplot(ri, main = "Optimale Prognose Ridge, n = 100, N = 100", ylim = c(-8.5,1), ylab = "log(lambda)")
#boxplot(la, main = "Optimale Prognose Lasso, n = 100, N = 100", ylim = c(-8.5,1), ylab = "log(lambda)")
#boxplot(el, main = "Optimale Prognose Elastic Net 0.5, n = 100, N = 100", ylim = c(-8.5,1), ylab = "log(lambda)")
